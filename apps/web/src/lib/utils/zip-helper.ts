    ...
    return new Promise((resolve, reject) => {
        ...
        Promise.all(fileReaders).then(() => {
            ...
            zip(zipData, { level: 0 }, (err, data) => {
                ...
                // fflate's zip() callback returns Uint8Array; we cast to BlobPart to bypass
                // the SharedArrayBuffer vs ArrayBuffer DOM typing mismatch without using `any`.
                const zipBlob = new Blob([data as unknown as BlobPart], { type: 'application/zip' });
